...
Revision ID: c0d2b08a7e2e
Revises: 
Create Date: 2021-04-13 16:56:28.405206
...
def upgrade():
    ...
    sa.Column('supplier_cost_price', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.Column('unit_retail_price', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('total_retail_price', sa.Numeric(precision=10, scale=2), nullable=False),
